// This hook comes from https://stackblitz.com/edit/vitejs-vite-x1cial?file=src%2Fuse-refinement.ts,src%2Fpet-editor.tsx
// Solves the issue with async validation with Zod and React Hook Form
